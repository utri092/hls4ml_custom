# Remove the current test project (if exists)
rm -rf my-hls-test/
...
hls4ml convert -c keras-config-smart-parking.yml
# Go to the created directory
cd my-hls-test
# Activate Vivado HLS CLI
source ~/Xilinx/Vivado/2020.1/settings64.sh
# Pre Synthesis Simulation & Synthesis (simulation results print on terminal)
